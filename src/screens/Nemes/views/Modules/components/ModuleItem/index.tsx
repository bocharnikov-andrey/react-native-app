...
const layoutByModuleType: Record<ModuleTypes, FC<{moduleRank: number}>> = {
  [ModuleTypes.nemeModule]: NemesLayout,
  [ModuleTypes.marketModule]: MarketsLayout,
...
const ModuleItem: FC<Props> = ({ module, rank }) => {
  ...
  const LayoutComponent = layoutByModuleType[type];
  ...
  return (
    <ModuleProvider value={{ module }}>
      <View style={componentStyles.container}>
        ...
        />
        <LayoutComponent moduleRank={rank} />
      </View>
    </ModuleProvider>
  );
};
